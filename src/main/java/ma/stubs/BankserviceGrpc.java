...
public final class BankserviceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest,
      ma.stubs.Bank.ConvertcurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = ma.stubs.Bank.ConvertcurrencyRequest.class,
      responseType = ma.stubs.Bank.ConvertcurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest,
      ma.stubs.Bank.ConvertcurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest, ma.stubs.Bank.ConvertcurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankserviceGrpc.getConvertMethod) == null) {
      synchronized (BankserviceGrpc.class) {
        if ((getConvertMethod = BankserviceGrpc.getConvertMethod) == null) {
          BankserviceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<ma.stubs.Bank.ConvertcurrencyRequest, ma.stubs.Bank.ConvertcurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Bankservice", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.stubs.Bank.ConvertcurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.stubs.Bank.ConvertcurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest,
      ma.stubs.Bank.ConvertcurrencyResponse> getGetCurrentStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest,
      ma.stubs.Bank.ConvertcurrencyResponse> getGetCurrentStreamMethod() {
    io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest, ma.stubs.Bank.ConvertcurrencyResponse> getGetCurrentStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest,
      ma.stubs.Bank.ConvertcurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest,
      ma.stubs.Bank.ConvertcurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest, ma.stubs.Bank.ConvertcurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest,
      ma.stubs.Bank.ConvertcurrencyResponse> getFullCurrentStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest,
      ma.stubs.Bank.ConvertcurrencyResponse> getFullCurrentStreamMethod() {
    io.grpc.MethodDescriptor<ma.stubs.Bank.ConvertcurrencyRequest, ma.stubs.Bank.ConvertcurrencyResponse> getFullCurrentStreamMethod;
  ...
  public static abstract class BankserviceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(ma.stubs.Bank.ConvertcurrencyRequest request,
        io.grpc.stub.StreamObserver<ma.stubs.Bank.ConvertcurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getCurrentStream(ma.stubs.Bank.ConvertcurrencyRequest request,
        io.grpc.stub.StreamObserver<ma.stubs.Bank.ConvertcurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.stubs.Bank.ConvertcurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<ma.stubs.Bank.ConvertcurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.stubs.Bank.ConvertcurrencyRequest> fullCurrentStream(
        io.grpc.stub.StreamObserver<ma.stubs.Bank.ConvertcurrencyResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ma.stubs.Bank.ConvertcurrencyRequest,
                ma.stubs.Bank.ConvertcurrencyResponse>(
  ...
  public static final class BankserviceBlockingStub extends io.grpc.stub.AbstractStub<BankserviceBlockingStub> {
     ...
     * </pre>
     */
    public ma.stubs.Bank.ConvertcurrencyResponse convert(ma.stubs.Bank.ConvertcurrencyRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<ma.stubs.Bank.ConvertcurrencyResponse> getCurrentStream(
        ma.stubs.Bank.ConvertcurrencyRequest request) {
  ...
  public static final class BankserviceFutureStub extends io.grpc.stub.AbstractStub<BankserviceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ma.stubs.Bank.ConvertcurrencyResponse> convert(
        ma.stubs.Bank.ConvertcurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((ma.stubs.Bank.ConvertcurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.stubs.Bank.ConvertcurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_CURRENT_STREAM:
          serviceImpl.getCurrentStream((ma.stubs.Bank.ConvertcurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.stubs.Bank.ConvertcurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankserviceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ma.stubs.Bank.getDescriptor();
    }
